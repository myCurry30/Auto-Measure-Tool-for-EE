...
_EMBEDDED_MANUAL = r"""# EE Power On AutoTool V2.2.2 — 用户操作手册
...
class HelpDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("用户操作手册 — EE Power On AutoTool V2.2.2")
    ...
    def _strip_title_block(text: str) -> str:
        ...
        AutoTool V2.2.2", so the H1 heading, subtitle, and author lines in
