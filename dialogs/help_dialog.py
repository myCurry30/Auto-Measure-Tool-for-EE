...
_EMBEDDED_MANUAL = r"""# EE Power On AutoTool V2.1 — 用户操作手册
...
1. 双击 `EE_Power_On_AutoTool_V2.1.0_Setup.exe`
2. 点击 **Next**，阅读许可协议
...
3. 通过菜单 **Settings → MSO Horizontal** 设置水平时基
...
#### 5.4.1 CH Label Naming 模式（按通道标签命名截图）

勾选 Actions 卡片中的 **Use CH Label Naming** 复选框后：
