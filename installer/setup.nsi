...
;   - PyInstaller output: dist\EE_Power_On_AutoTool.exe
;
; Build:
...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\EE_Power_On_AutoTool.exe"
...
Section "MainSection" SEC01
    ...
    WriteRegStr HKLM "${PRODUCT_UNINST_KEY}" "DisplayIcon"          "$INSTDIR\EE_Power_On_AutoTool.exe"
    ...
    WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\EE_Power_On_AutoTool.exe"
    ...
    CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME}.lnk" \
        "$INSTDIR\EE_Power_On_AutoTool.exe"
...
Section "Uninstall"
    ...
    nsExec::ExecToStack 'taskkill /f /im "EE_Power_On_AutoTool.exe"'
    Pop $0
    Sleep 1000
    ...
    Delete "$INSTDIR\EE_Power_On_AutoTool.exe"
