Unicode true
; ═══════════════════════════════════════════════════════════════════════════════
; NSIS Installer Script — EE Power On AutoTool V2.1
;
; Prerequisites:
;   - NSIS 3.x  (https://nsis.sourceforge.io/Download)
;   - PyInstaller output: dist\EE_Power_On_AutoTool_V2.1.0.exe
;
; Build:
;   makensis installer\setup.nsi
;
; Output:
;   installer\EE_Power_On_AutoTool_V2.1_Setup.exe
; ═══════════════════════════════════════════════════════════════════════════════
...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\EE_Power_On_AutoTool_V2.1.0.exe"
...
Section "MainSection" SEC01
    ...
    ; ── Main executable ──────────────────────────────────────────────────
    File "..\dist\EE_Power_On_AutoTool_V2.1.0.exe"
    ...
    WriteRegStr HKLM "${PRODUCT_UNINST_KEY}" "DisplayIcon"          "$INSTDIR\EE_Power_On_AutoTool_V2.1.0.exe"
    ...
    WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\EE_Power_On_AutoTool_V2.1.0.exe"
    ...
    CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME}.lnk" \
        "$INSTDIR\EE_Power_On_AutoTool_V2.1.0.exe"
...
Section "Uninstall"
    ...
    nsExec::ExecToStack 'taskkill /f /im "EE_Power_On_AutoTool_V2.1.0.exe"'
    Pop $0
    Sleep 1000
    ...
    Delete "$INSTDIR\EE_Power_On_AutoTool_V2.1.0.exe"
